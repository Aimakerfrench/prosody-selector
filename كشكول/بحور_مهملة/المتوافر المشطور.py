# تمّ توليد البحر المديد المجزوء 3 مرات وفق أنواع كما في الشرح المثبت في ملف الإكسل

import itertools

# تعريف الخيارات الممكنة لكل كلمة في الشطر الأول
shatr1_options = [
    ["فَاْعِلُنْ"],              # الكلمة الثانية
    ["فَاْعِلَاْتُنْ"]        
]

shatr2_options = [
    ["فَاْعِلُنْ"],                      # الكلمة الأولى
    ["فَاْعِلَاْتُنْ"]           
...
with open('المتوافر المشطور.txt', 'w', encoding='utf-8') as f:
